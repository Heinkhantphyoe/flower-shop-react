    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow shadow-gray-400 border border-white/20 p-8">
          ...
          {/* Google Sign-In — GoogleLogin returns a JWT credential; useGoogleLogin only returns an access_token */}
          {googleClientId ? (
            <div className={`w-full flex justify-center ${isGoogleLoading ? 'pointer-events-none opacity-50' : ''}`}>
              <GoogleLogin
